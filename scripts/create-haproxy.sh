...
BRIDGE=vmbr0
# VLAN=20  This is unessecary and breaks the ability to even install HAproxy... -mdudki
STORAGE=zfs-intel
PATH=$(pwd)
...
/usr/sbin/pct exec $ID -- bash -c 'echo deb http://haproxy.debian.net bookworm-backports-2.3 main | tee /etc/apt/sources.list.d/haproxy.list'
